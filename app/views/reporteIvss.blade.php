	...
	<div class="row">
		...
		<footer>
			<table class="pie" style="width:100%">
				<tr>
					<th class="pie">OBSERVACIONES:</th>
					<th class="pie" colspan="3">LUGAR</th>
					<th class="pie">NOMBRE Y APELLIDO DEL REPRESENTANTE</th>
					<th class="pie" rowspan="2">FIRMA Y SELLO</th>
				</tr>
				<tr>
					<th class="pie pi2">R.P.E.= RÉGIMEN PRESTACIONAL DE EMPLEO</th>
					<th class="pie pi2" colspan="3">CARACAS</th>
					<th class="pie pi2">JOSÉ PEREIRA</th>
				</tr>
			</table>
		</footer>
	</div>
